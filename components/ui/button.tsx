...
const buttonVariants = cva(
  // Base — premium micro-interactions, hardware-accelerated
  ...
  "[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        // Navy with gold shimmer on hover
        default:
        ...
        gold:
          ...
          "hover:bg-accent/90 hover:shadow-md hover:shadow-accent/30",
        ...
        destructive:
          ...
          "hover:bg-destructive/18 hover:shadow-sm " +
