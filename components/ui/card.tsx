  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Border — subtle platinum, with hover gold tint when interactive
        ...
        // Optional interactive micro-animation
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-xl border-t border-border/60 bg-muted/30 p-4",
